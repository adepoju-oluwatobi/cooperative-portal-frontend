    ...
    <>
      ...
      >
        <nav className="flex flex-col gap-4 rounded-lg bg-black p-8 text-white text-center mt-2 w-[90%] m-auto">
          ...
          <a href="https://portal.honeylandschools-cooperative-society.com.ng/" className="primary-btn m-auto">
            Go to portal
          </a>
        </nav>
      </div>
      ...
      <div className="hidden bg-slate-200 md:flex justify-between items-center p-2">
        ...
        <div>
          <nav className="text-xs">
            ...
            <a href="https://portal.honeylandschools-cooperative-society.com.ng/"
